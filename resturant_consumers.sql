...
select  distinct res.name,res.city,ra.overall_rating from restaurants as res left join ratings as ra 
...
CREATE PROCEDURE GetRestaurantRatingsAboveThreshold1 (
...
CALL GetRestaurantRatingsAboveThreshold1(132825, 2);
...
CREATE VIEW ConsumerAverageRatings1 AS
SELECT
    consumer_id,
